...
export const SearchPanel = ({initialData, displayedData, changeDisplayedData, changeCurrentPage}) => {
  ...
  return (
    <div className={style.search}>
      ...
      <div>
        <input type='radio' name='radio' value='up' onChange={(e)=>changeSortDirectionHandler(e.target.value)}/>
        <label htmlFor='radio'> - по возрастанию цены</label>
      </div>
      <div>
        <input type='radio' name='radio' value='down' onChange={(e)=>changeSortDirection(e.target.value)}/>
        <label htmlFor='radio'> - по убыванию цены</label>
      </div>
      <div>
        <input type='radio' name='radio' value='time' onChange={(e)=>changeSortDirection(e.target.value)}/>
      ...
      <div>
        <input type='checkbox' onChange={(e)=>filterF1Handler(e.target.checked)} disabled={changeDisabledOneTransfer()}/> - 1 пересадка
      </div>
      <div>
        <input type='checkbox' onChange={(e)=>filterF0Handler(e.target.checked)} disabled={changeDisabledNoTransfer()}/> - без пересадок
      </div>
      <div>
        <b>Цена</b>
      </div>
